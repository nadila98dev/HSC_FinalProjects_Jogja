...
const MenuSmall = () => {
  ...
  return (
    <div
      className="flex flex-col max-w-screen h-fit items-center
        lg:hidden
    "
    >
      <div className="my-5 w-[100%]">
        ...
        <div className="bg-button2 flex flex-col gap-3 px-5 py-3 font-Poppins">
          {category.map((item) => (
            <div
              key={item.id}
              onClick={() => navigateToPageJogja(`/things-to-do/${item.slug}`)}
      ...
      <div className="mb-5 w-[100%]">
        ...
        <div className="bg-button2 flex flex-col gap-3 px-5 py-3 font-Poppins">
          ...
          <div
            className="flex justify-between items-center menu__text"
            onClick={() =>
              navigateToAirplaneTipsPage("/practical-tips-page/airplane")
            }
          >
      ...
      <div
        className="fixed z-[1600] bottom-10 flex justify-center items-center
            lg:hidden
            "
      >
        <button
        ...
        <button
          onClick={() => navigateToSavedPage("/saved-page")}
        ...
        >
          ...
          {showSpan && (
            <span className="absolute text-[80px] bottom-[1px] right-[7px]">
              .
            </span>
          )}
        </button>
